      ...
      <section className="relative px-6 pb-24 pt-32 lg:px-10 lg:pb-32 lg:pt-40">
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="relative">
            <div className="absolute -left-10 -top-10 hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-5 py-4 shadow-[0_20px_70px_rgba(15,23,42,0.08)] backdrop-blur transition-all duration-500 hover:-translate-y-2 hover:border-cyan-200 hover:shadow-[0_26px_80px_rgba(14,165,233,0.16)] md:block">
            ...
            <div className="absolute -right-8 top-20 hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-5 py-4 shadow-[0_20px_70px_rgba(15,23,42,0.08)] backdrop-blur transition-all duration-500 hover:-translate-y-2 hover:border-cyan-200 hover:shadow-[0_26px_80px_rgba(14,165,233,0.16)] md:block">
              <div className="flex items-center gap-3">
            ...
            <div className="absolute bottom-12 left-0 z-20 hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-5 py-4 shadow-[0_20px_70px_rgba(15,23,42,0.08)] backdrop-blur transition-all duration-500 hover:-translate-y-2 hover:border-cyan-200 hover:shadow-[0_26px_80px_rgba(14,165,233,0.16)] md:block">
              <div className="flex items-center gap-3">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              <h2 className="font-serif text-5xl font-semibold leading-[0.95] tracking-[-0.055em] text-slate-950 dark:text-slate-50 md:text-7xl">
                ...
                <span className="text-slate-400 dark:text-slate-500">The issue was the path.</span>
              </h2>
            </div>
